...
public class Bfunction {
    ...
    public Bfunction(){
        ...
        //System.out.println("function map "+functionParamMap);
    ...
    public synchronized boolean bfunc(String bfunctionName, Map<String, Map<String, String>> params) {
        //System.out.println("in bfunc function map "+functionParamMap);
        //System.out.println("bfunctionName "+bfunctionName);
        //System.out.println("functionValyeMap"+functionValueMap);
        //System.out.println(functionValueMap.containsKey(bfunctionName));
        //System.out.println("here");
        if(functionValueMap.containsKey(bfunctionName)==false){
            //System.out.println("error");
            assert false :"unknown bfunction";
